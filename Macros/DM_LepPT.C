...
TChain DM("bdttree");
DM.Add("~cbeiraod/local-area/Stop4Body/nTuples_v2016-11-23/T2DegStop_deltaM30.root");
...
TH1F *dm1 = new TH1F("dm1","pT(l)",Xbin,Xmin,Xmax);
DM.Draw("LepPt>>dm1",presel+s250n220);
double tn = dm1->GetEntries();
dm1->Scale(1./tn);
dm1->SetLineColor(1);
dm1->SetLineWidth(2);
TH1F *dm2 = new TH1F("dm2","pT(l)",Xbin,Xmin,Xmax);
DM.Draw("LepPt>>dm2",presel+s300n270);
double sn = dm2->GetEntries();
dm2->Scale(1./sn);
dm2->SetLineColor(2);
dm2->SetLineWidth(2);
TH1F *dm3 = new TH1F("dm3","pT(l)",Xbin,Xmin,Xmax);
DM.Draw("LepPt>>dm3",presel+s400n370);
double w1n = dm3->GetEntries();
dm3->Scale(1./w1n);
dm3->SetLineColor(3);
dm3->SetLineWidth(2);
TH1F *dm4 = new TH1F("dm4","pT(l)",Xbin,Xmin,Xmax);
DM.Draw("LepPt>>dm4",presel+s500n470);
