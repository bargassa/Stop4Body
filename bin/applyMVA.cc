...
int main(int argc, char** argv)
{
  ...
  Float_t LepPt, LepEta, LepDxy, LepDz, Met, mt_old, Q80_old, CosDeltaPhi_old;
  ...
  //  reader->AddVariable("Q80_old", &Q80_old);
  //  reader->AddVariable("CosDeltaPhi_old", &CosDeltaPhi_old);
  ...
  for(auto & file : filesToProcess)
  {
    ...
    OutputTree->SetBranchAddress("mt_old",  &mt_old);
    OutputTree->SetBranchAddress("Q80_old", &Q80_old);
    OutputTree->SetBranchAddress("CosDeltaPhi_old",&CosDeltaPhi_old);
